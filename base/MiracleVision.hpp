...
// ONNX Runtime 库，用于深度学习模型推理
#include <onnxruntime/onnxruntime_cxx_api.h> // C++ API
#include <onnxruntime/onnxruntime_c_api.h>   // C API
...
#include "module/armor/DNN_armor.hpp"       // 基于 DNN (如 YOLOv8) 的装甲板检测
#include "module/buff/basic_buff.hpp"       // 基础能量机关检测
#include "module/ml/onnx_inferring.hpp"     // ONNX 模型推理通用模块（未在主程序中直接使用）
